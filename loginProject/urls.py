...
urlpatterns = [
    ...
    path('add_to_favorites/<str:crypto_id>/', views.add_to_favorites, name='add_to_favorites'),
    path('remove_from_favorites/<str:crypto_id>/', views.remove_from_favorites, name='remove_from_favorites'),
    ...
    path('crypto/<str:crypto_id>/', views.crypto_details, name='crypto_details'),
